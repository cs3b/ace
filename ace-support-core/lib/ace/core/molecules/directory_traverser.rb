  ...
  module Core
    module Molecules
      ...
      class DirectoryTraverser
        attr_reader :config_dir_name

        # Initialize traverser
        # @param config_dir_name [String] Name of config directory to find (default: ".ace")
        ...
        def traverse
          ...
          loop do
            ...
            config_path = File.join(current_path, @config_dir_name)
        ...
        def find_config_directories
          traverse.map { |dir| File.join(dir, @config_dir_name) }
        end
        ...
        def build_cascade_priorities
          ...
          home_config = File.expand_path("~/#{@config_dir_name}")
