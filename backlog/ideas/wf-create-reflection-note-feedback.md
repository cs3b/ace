...
1. if you would need to do it again, how would you automate some parts,
- by code (tools)
- by templates
- by task definition
    - what would you add
...
- example of cookbooks ideas:
  ...
  - setup ATOM architecture for ruby gem
- we probably should have additional workflow (create-cookbook.wf.md) so we can pass the workflow and the context
