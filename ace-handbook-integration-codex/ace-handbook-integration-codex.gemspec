...
require_relative "lib/ace/handbook/integration/codex/version"

Gem::Specification.new do |spec|
  spec.name = "ace-handbook-integration-codex"
  spec.version = Ace::Handbook::Integration::Codex::VERSION
  spec.authors = ["Michal Czyz"]
  spec.email = ["mc@cs3b.com"]
  spec.summary = "Codex provider integration for ACE handbook skills"
  spec.description = "Codex-specific provider integration package that extends ace-handbook with provider manifests."
