...
# Load all ace-support-tmux components
...
module Ace
  module Support
    module Tmux
      ...
      def self.gem_root
        @gem_root ||= Gem.loaded_specs["ace-support-tmux"]&.gem_dir ||
      ...
      # Load ace-support-tmux configuration using ace-config cascade
      ...
      def self.load_config
        ...
        warn "ace-support-tmux: Could not load config: #{e.class} - #{e.message}" if debug?
