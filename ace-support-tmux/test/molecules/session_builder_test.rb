...
class SessionBuilderTest < Minitest::Test
  def setup
    ...
    loader = Ace::Support::Tmux::Molecules::PresetLoader.new(
      gem_root: @temp_dir,
      start_path: @temp_dir
    )
  ...
  def test_build_returns_session_model
    ...
    assert_instance_of Ace::Support::Tmux::Models::Session, session
  ...
  def test_build_raises_for_missing_preset
    assert_raises(Ace::Support::Tmux::Molecules::PresetNotFoundError) do
  ...
  def test_build_window_returns_window_model
    ...
    assert_instance_of Ace::Support::Tmux::Models::Window, window
  ...
  def nested_builder(temp_dir)
    ...
    Ace::Support::Tmux::Molecules::SessionBuilder.new(preset_loader: loader)
  end
