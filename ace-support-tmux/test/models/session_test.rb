...
class SessionModelTest < Minitest::Test
  ...
  def test_full_initialization
    window = Ace::Support::Tmux::Models::Window.new(name: "editor")
    session = Ace::Support::Tmux::Models::Session.new(
      name: "dev",
      root: "~/projects/app",
      windows: [window],
  ...
  def test_attach_predicate
    assert Ace::Support::Tmux::Models::Session.new(name: "s", attach: true).attach?
    refute Ace::Support::Tmux::Models::Session.new(name: "s", attach: false).attach?
    assert Ace::Support::Tmux::Models::Session.new(name: "s").attach?
  end
