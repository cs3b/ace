...
class PaneModelTest < Minitest::Test
  def test_default_initialization
    pane = Ace::Support::Tmux::Models::Pane.new
  ...
  def test_focus_predicate
    assert Ace::Support::Tmux::Models::Pane.new(focus: true).focus?
    refute Ace::Support::Tmux::Models::Pane.new(focus: false).focus?
    refute Ace::Support::Tmux::Models::Pane.new.focus?
  end
  ...
  def test_to_h_omits_nil_optional_fields
    pane = Ace::Support::Tmux::Models::Pane.new(commands: ["bash"])
    hash = pane.to_h
  ...
  def test_options_passthrough
    ...
    pane = Ace::Support::Tmux::Models::Pane.new(options: opts)
