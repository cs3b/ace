...
- [x] Review current escape_argument implementation
...
- [x] Step 1: Import Shellwords module
  - Add `require 'shellwords'` at the top of the file
- [x] Step 2: Replace escape_argument calls with Shellwords.escape
...
- [x] Step 4: Update any helper method that wraps escaping
  - If there's a convenience method, update it to use Shellwords
- [x] Step 5: Test with edge cases
...
- [x] AC 1: Custom escape_argument method is removed
- [x] AC 2: All escaping uses Shellwords.escape from standard library
- [x] AC 3: All edge cases are properly handled (quotes, spaces, metacharacters)
- [x] AC 4: All existing tests pass
- [x] AC 5: No breaking changes for consumers of ShellCommandExecutor
- [x] AC 6: Security is improved with more robust escaping
