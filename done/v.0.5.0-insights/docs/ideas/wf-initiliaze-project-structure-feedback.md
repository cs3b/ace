...
2. there are no more binstub tools (bin/tn, bin/gc, etc.) - use .ace/tools commands instead (task-manager next, git-commit, etc.)
...
4. it still create decisions directory in the .ace/taskflow -> docs/decisions
