...
1. What is the exact path structure for the "current release folder" that the `../docs/ideas/` directory should be relative to? (e.g., is it `.ace/taskflow/current/` or a more dynamic path based on the release version?)
...
1. in claude /draft-task .ace/taskflow/current/v.0.4.0-replanning/backlog/ideas/20250730-2327-auto-commit-ideas.md
2. claude create new task .ace/taskflow/current/v.0.4.0-replanning/tasks/v.0.4.0+task.009-add-commit-flag-to-ideas-manager.md
3. after task is created it will move the original idea file to: .ace/taskflow/current/v.0.4.0-replanning/docs/ideas/009-20250730-2327-auto-commit-ideas.md

## Big Unknowns

**Technical Unknowns:**
- Specific Ruby libraries or methods within the `.ace/tools` gem that are best suited for abstracting file system operations and adhering to ATOM principles.
