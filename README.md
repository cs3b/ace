...
* **`guides/`**: Contains detailed guides on various development practices.
  * **`guides/`**: Conceptual guides, best practices, and standards for development within this project. These explain *how* we do things. This directory includes a `.meta/` subdirectory for guides that are self-referential, describing the process of creating or maintaining the documentation and workflows themselves.
