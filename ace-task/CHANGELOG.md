...
### Fixed
- Hardened `TS-TASK-001` task-ref handling so the show/list lifecycle E2E reuses the exact created task reference without truncation or normalization drift.
...
### Changed
- Role-based planning and doctor defaults.
