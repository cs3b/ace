...
5. **Directories exist** — the sandbox filesystem contains the two created worktree directories after the create commands complete.

## Verdict

- **PASS**: List starts with main only, both creations succeed, list after shows all three worktrees, and the created directories exist in sandbox state.
