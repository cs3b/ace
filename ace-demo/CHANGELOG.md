...
### Technical
- Register package-level `.ace-defaults` skill-sources for ace-demo to enable canonical skill discovery in fresh installs.


## [0.23.1] - 2026-03-29

### Fixed
- **ace-demo v0.23.1**: Bumped dependency constraints to currently available `~>` ranges on RubyGems and updated release metadata after dependency synchronization.
