...
- HTTP client strategy (ADR-009) due to `FaradayDryMonitorLogger` integration.
- Error reporting strategy (ADR-010) for consistency in handling exceptions, although `dry-monitor` focuses on events.
