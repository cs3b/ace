...
bin/cr
```
- Wraps the `dev-handbook/tools/generate-code-review-prompt` tool
...
- For detailed setup and usage, refer to the [VCR Testing Guide](docs/development/guides/testing-with-vcr.md).
