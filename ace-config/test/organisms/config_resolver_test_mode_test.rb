  ...
  module Config
    class ConfigResolverTestModeTest < TestCase
      ...
      def test_class_test_mode_setter
        ...
        assert Ace::Config.test_mode?

        Ace::Config.test_mode = false
        refute Ace::Config.test_mode?
      end

      def test_class_default_mock_setter
        Ace::Config.default_mock = { "default" => "mock_value" }
        assert_equal({ "default" => "mock_value" }, Ace::Config.default_mock)
      end
      ...
      def test_create_uses_class_default_mock
        Ace::Config.test_mode = true
        Ace::Config.default_mock = { "class_mock" => "value" }
      ...
      def test_create_explicit_test_mode_overrides_class_setting
        ...
        resolver = Ace::Config.create(test_mode: false)
        refute resolver.test_mode?
      end

      def test_create_explicit_mock_config_overrides_default_mock
        Ace::Config.test_mode = true
        Ace::Config.default_mock = { "default" => "value" }

        resolver = Ace::Config.create(mock_config: { "explicit" => "override" })
        config = resolver.resolve
      ...
      def test_reset_config_clears_test_mode
        ...
        refute Ace::Config.test_mode?
        assert_nil Ace::Config.default_mock
      end
    end
  end
end
