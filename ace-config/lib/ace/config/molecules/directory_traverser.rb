...
module Ace
  module Config
    module Molecules
      ...
      #
      # Note: This class only handles project-level directory traversal
      # (current directory to project root). Gem defaults are handled
      # separately by ConfigFinder and VirtualConfigResolver.
