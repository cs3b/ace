...
This guide explains all configuration options available in ace-context YAML presets, including both simplified and section-based formats.

## Overview

ace-context supports two configuration approaches:
...
When using simplified format, ace-context automatically organizes content into sections:
...
This configuration guide covers all available options in ace-context presets. Choose the format and features that best match your use case, from simple file listings to complex multi-section contexts with preset composition.