...
- Familiarity with the [Project Management Guide](docs-dev/guides/project-management.md), particularly task
...
- [Project Management Guide](docs-dev/guides/project-management.md) (Defines task statuses, priorities, and overall
  project structure)
