...
5. **Update Version Numbers:**
   ...
   * _Refer to project-specific version file locations in [`docs-dev/guides/publish-release.md`](../guides/publish-release.md)_
...
6. **Generate Final Changelog:**
   ...
   * _Follow format specified in [`docs-dev/guides/changelog-guide.md`](../guides/changelog-guide.md)_
...
11. **Authenticate with Package Registry:**
    ...
    * _Refer to language-specific guides in [`docs-dev/guides/publish-release/`](../guides/publish-release/) if available_
...
1. **Build Failures:**
   ...
   * Consult [`docs-dev/workflow-instructions/fix-tests.md`](./fix-tests.md) if test-related
...
* **Primary Conceptual Guide:** [`docs-dev/guides/publish-release.md`](../guides/publish-release.md)
