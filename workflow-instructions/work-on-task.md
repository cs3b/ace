...
* Run the [`load-env`](docs-dev/workflow-instructions/load-env.md) workflow instruction first to load project context,
...
3. **Load Context:**
    * Identify relevant project context needed for execution:
        * **General Guides:** (e.g., `coding-standards.md`, `testing.md`, `architecture.md`,
          [Embedding Tests in AI Agent Workflows](docs-dev/guides/embedding-tests-in-workflows.md)). These might be
...
4. **Execute Task Plan Step-by-Step:**
    ...
    * **Iterate through Checklist:** For each `- [ ]` item:
        ...
        3. **Follow Task Cycle Principles (for code changes):** If the primary action of the checklist item involved
           ...
           [Implementing the Task Cycle Guide](docs-dev/guides/test-driven-development-cycle.md) principles
    ...
    * **Commit Appropriately:** Decide on commit frequency. Commit after each logical step (i.e., a checklist item
      ...
      [`commit.md`](docs-dev/workflow-instructions/commit.md) (or renamed equivalent).
...
* [Embedding Tests in AI Agent Workflows Guide](docs-dev/guides/embedding-tests-in-workflows.md) (Details how to write
