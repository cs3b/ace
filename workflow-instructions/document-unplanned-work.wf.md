...
- Access to task-manager CLI tool for creating tasks
...
2. **Create Task Record:**
   ...
   ```bash
   task-manager create --title "[Descriptive title of work completed]"
   ```

   Example:
   ```bash
   task-manager create --title "Fix invalid Claude tool specifications in command metadata"
   ```
