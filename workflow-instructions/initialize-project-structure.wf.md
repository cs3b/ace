...
- [Project Management Guide](docs-dev/guides/project-management.g.md) (Explains the created structure)
- [Picking Codenames Guide](docs-dev/guides/release-codenames.g.md) (Guidance for selecting appropriate codenames)
