...
1.  **Identify Core Project Documents:** Ensure `docs-project/what-do-we-build.md` and `docs-project/architecture.md` are up-to-date.
...
5.  **Save:** Save the updated `docs-project/blueprint.md`.
