...
6.  **Consistency:** Use consistent terminology, formatting, and structure across all guides. Refer to terms defined in other guides or the main [Project Management Guide](dev-handbook/guides/project-management.g.md).
...
- Use clear language: "To implement these security principles, see [Security Audit Workflow](dev-handbook/workflow-instructions/security-audit.wf.md)"
...
- Use format: "For background on these testing principles, see [Testing Guide](dev-handbook/guides/testing.g.md)"
...
6.  **Related Documentation:** Link to other relevant guides, workflow instructions, or templates using paths relative to the project root (e.g., `[Project Management Guide](dev-handbook/guides/project-management.g.md)`), **not** relative to the current file (e.g., `../project-management.g.md`). Always link to workflows when discussing implementation of the concepts covered.
...
For the specific steps to conduct a code review, see [Code Review Workflow](dev-handbook/workflow-instructions/code-review.wf.md).
```
...
For the specific steps to create and run migrations, see [Database Migration Workflow](dev-handbook/workflow-instructions/database-migration.wf.md).
```
