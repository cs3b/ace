...
class GithubIssueSyncTest < AceGitGithubTestCase
  def test_sync_task_creates_sticky_comment_and_label
    ...
    Ace::Git::Github::CliExecutor.stub :execute, executor do
      stub_git_identity do
        result = Ace::Git::Github::IssueSync.sync_task(
          task_id: "8r4.t.ilo.2",
  ...
  def test_validate_link_rejects_issue_owned_by_another_task
    ...
    Ace::Git::Github::CliExecutor.stub :execute, executor do
      err = assert_raises(Ace::Git::Github::IssueSync::OwnershipConflict) do
        Ace::Git::Github::IssueSync.validate_link!(issue_id: 276, task_id: "8r4.t.i68.1")
      end
