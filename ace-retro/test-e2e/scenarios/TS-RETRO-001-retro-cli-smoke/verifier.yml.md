---
description: "E2E verifier input for ace-retro CLI smoke"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-001-help-and-usage.verify.md
    - ./TC-002-create-list-show-lifecycle.verify.md
    - ./TC-003-folder-and-filter-views.verify.md
    - ./TC-004-doctor-health-to-failure.verify.md
---

# E2E Verification: ace-retro CLI Smoke
