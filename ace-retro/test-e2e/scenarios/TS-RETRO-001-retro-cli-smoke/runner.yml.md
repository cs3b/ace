---
description: "E2E runner input for ace-retro CLI smoke"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-001-help-and-usage.runner.md
    - ./TC-002-create-list-show-lifecycle.runner.md
    - ./TC-003-folder-and-filter-views.runner.md
    - ./TC-004-doctor-health-to-failure.runner.md
---

# E2E Test Runner: ace-retro CLI Smoke

Tool under test: ace-retro
Required tools: ace-retro, git
