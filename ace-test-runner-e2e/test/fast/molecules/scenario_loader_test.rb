...
class ScenarioLoaderTest < Minitest::Test
  ...
  def test_load_standalone_marks_optional_declared_artifacts
    Dir.mktmpdir do |tmpdir|
      scenario_dir = create_scenario_dir(tmpdir, "TS-OPTIONAL-001",
        scenario_yml: <<~YAML,
          test-id: TS-OPTIONAL-001
