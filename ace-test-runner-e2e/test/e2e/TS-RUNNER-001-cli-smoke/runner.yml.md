---
description: "E2E runner input for ace-test-runner-e2e CLI smoke"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-001-help-command-surface.runner.md
    - ./TC-002-invalid-package-dry-run.runner.md
    - ./TC-003-dry-run-discovers-repo-scenarios.runner.md
    - ./TC-004-suite-help-command-surface.runner.md
---

# E2E Test Runner: ace-test-runner-e2e CLI Smoke

Tool under test: ace-test-e2e, ace-test-e2e-suite
Required tools: ace-test-e2e, ace-test-e2e-suite, git
