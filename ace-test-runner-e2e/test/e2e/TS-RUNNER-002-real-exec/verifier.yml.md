---
description: "E2E verifier input for ace-test-runner-e2e real execution coverage"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-001-real-package-run.verify.md
    - ./TC-002-verifier-output.verify.md
    - ./TC-003-shell-helper-surface.verify.md
---

# E2E Verification: ace-test-runner-e2e Real Run + Verify + Shell Helper
