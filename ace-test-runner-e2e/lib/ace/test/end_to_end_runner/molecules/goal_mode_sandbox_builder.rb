...
module Ace
  module Test
    module EndToEndRunner
      module Molecules
        # Builds deterministic sandbox state for standalone goal-mode execution.
        class GoalModeSandboxBuilder
          MISE_TEMPLATE = <<~TOML
            # Auto-generated by ace-test-e2e goal-mode pipeline
            [vars]
            _.file = ["~/.ace/.env"]
          ...
          def initialize_git_repo(sandbox_path)
            ...
            raise "Goal-mode sandbox git init failed: #{stderr}".strip
          end
          ...
          def verify_tool_access(scenario, sandbox_path)
            ...
            raise "Goal-mode sandbox tool check failed for #{tool}: #{stderr}".strip
          end
        end
      end
    end
