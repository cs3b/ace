---
description: "E2E verifier input for RubyGems install verification"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-001-discover-gems.verify.md
    - ./TC-002-sandbox-install.verify.md
    - ./TC-003-fullindex-fallback.verify.md
    - ./TC-004-classify-result.verify.md
---

# E2E Verification: RubyGems Install Verification
