...
bundle:
  ...
  files:
    ...
    - ./TC-005-fresh-setup-contract.runner.md
    - ./TC-006-commit-fallback.runner.md
---

# E2E Test Runner: Quick-Start Local Validation

Tools under test: ace-config, ace-handbook, ace-llm, ace-git-commit
Required tools: ace-idea, ace-task, ace-bundle, ace-nav, ace-search, ace-config, ace-handbook, ace-llm, ace-git-commit, git
