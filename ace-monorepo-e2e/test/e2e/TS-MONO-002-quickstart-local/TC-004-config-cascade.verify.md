...
3. **Override diff is detected** — `results/tc/04/config-diff.exit` is numeric and output file indicates a detected override (`CHANGED` for `.ace/git/commit.yml` or equivalent).
