...
require_relative '../../lib/ace/context'
require_relative '../../lib/ace/context/atoms/section_validator'
require_relative '../../lib/ace/context/molecules/section_processor'
require_relative '../../lib/ace/context/molecules/preset_manager'
require_relative '../../lib/ace/context/organisms/context_loader'
  ...
  module Context
    class SectionPresetTest < Minitest::Test
      ...
      def test_section_processor_handles_preset_loading_errors
        ...
        assert_raises(Ace::Context::Molecules::SectionValidationError) do
      ...
      def test_nested_preset_composition_error_handling
        ...
        error = assert_raises(Ace::Context::Molecules::SectionValidationError) do
          @section_processor.process_sections(
            { 'context' => { 'sections' => sections } },
            mock_preset_manager
          )
