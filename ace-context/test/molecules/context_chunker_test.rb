...
require "test_helper"
require "ace/context/molecules/context_chunker"

class ContextChunkerTest < AceTestCase
  def setup
    @chunker = Ace::Context::Molecules::ContextChunker.new(10) # Small limit for testing
  end
  ...
  def test_splits_plain_text_by_line_count
    ...
    lines = content.lines
    chunker = Ace::Context::Molecules::ContextChunker.new(10)
  ...
  def test_splits_at_file_element_boundaries
    ...
    lines = content.lines
    chunker = Ace::Context::Molecules::ContextChunker.new(5) # Force split between files
  ...
  def test_splits_at_output_element_boundaries
    ...
    lines = content.lines
    chunker = Ace::Context::Molecules::ContextChunker.new(4)
  ...
  def test_keeps_large_single_element_whole
    ...
    lines = content.lines
    chunker = Ace::Context::Molecules::ContextChunker.new(5) # Much smaller than element
  ...
  def test_mixed_content_with_files_and_outputs
    ...
    lines = content.lines
    chunker = Ace::Context::Molecules::ContextChunker.new(3)
