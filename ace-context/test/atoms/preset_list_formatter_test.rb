...
require "ace/context/atoms/preset_list_formatter"

class PresetListFormatterTest < AceTestCase
  def test_format_empty_presets
    result = Ace::Context::Atoms::PresetListFormatter.format([])
  ...
  def test_format_single_preset
    ...
    result = Ace::Context::Atoms::PresetListFormatter.format(presets)
  ...
  def test_empty_message_is_helpful
    result = Ace::Context::Atoms::PresetListFormatter.empty_message
