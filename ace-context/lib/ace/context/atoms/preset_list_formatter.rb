    ...
    module Atoms
      ...
      module PresetListFormatter
        ...
        def self.empty_message
          [
            "No presets found in .ace/context/presets/",
            "Create markdown files with YAML frontmatter in .ace/context/presets/ to define presets.",
            "Example presets are available in the ace-context gem at .ace-defaults/context/"
          ]
        end
      end
    end
