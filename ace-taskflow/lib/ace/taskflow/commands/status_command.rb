  ...
  module Taskflow
    module Commands
      ...
      class StatusCommand
        ...
        # Shows done/total format (distinct from tasks command which shows displayed/total)
        # @param release [Hash] Release info with :name, :done_tasks, :total_tasks, :codename
        # @return [String] Formatted header like "v.0.9.0: 125/136 tasks done • Mono-Repo Multiple Gems"
        def format_release_header(release)
          ...
          # Use "tasks done" to distinguish from tasks command's "displayed/total tasks"
