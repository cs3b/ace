...
4. For testing guidelines, use `ace-bundle load guide://testing-philosophy` or `ace-bundle load guide://mocking-patterns`
...
mkdir -p .cache/ace-taskflow/bug-analysis/{session}
```
...
---
*Run `/ace-bug-fix` to execute this fix plan*
```
