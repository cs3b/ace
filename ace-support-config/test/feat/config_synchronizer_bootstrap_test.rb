      ...
      class ConfigSynchronizerBootstrapTest < TestCase
        def test_sync_copies_generic_bootstrap_files
          with_temp_config do
            ...
            assert_includes agents, "## Principles"
            ...
            assert_includes claude, "Read `AGENTS.md` first."
        ...
        def test_sync_force_refreshes_generated_agent_guidance
          with_temp_config(
            ...
            assert_includes File.read("AGENTS.md"), "## Principles"
            ...
            assert_includes File.read("CLAUDE.md"), "Read `AGENTS.md` first."
