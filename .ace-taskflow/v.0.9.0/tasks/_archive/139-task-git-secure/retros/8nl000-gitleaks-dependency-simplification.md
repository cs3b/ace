...
- **Test token entropy awareness**: Low-entropy test tokens (`ghp_1234567890abcdefghijklmnopqrstuvwxyzAB`) weren't detected by gitleaks - required high-entropy patterns (`literal:[REDACTED:github-pat]`)
