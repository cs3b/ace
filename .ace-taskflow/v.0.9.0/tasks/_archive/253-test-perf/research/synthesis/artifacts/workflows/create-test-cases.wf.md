...
- Read: `ace-test/handbook/guides/testing-strategy.g.md` (Fast vs Slow Loop)
...
### Planning Steps (The "Test Planner")

- [ ] **Analyze requirements**: Identify the "Boundary" (logic vs I/O).
- [ ] **Determine Layers**:
  - [ ] **Unit**: Pure logic? (Mock everything, < 10ms)
  - [ ] **Integration**: Component wiring? (Stub external I/O, < 100ms)
  - [ ] **E2E**: Full workflow? (Real CLI/I/O, slow is okay)
- [ ] Identify test scenarios across different categories (happy path, edge cases, errors)

### Execution Steps (The "Test Writer")

- [ ] Create comprehensive test case structure using embedded template
- [ ] Generate test cases with "Stub the Boundary" principle
- [ ] Include implementation hints (stubbing examples)
