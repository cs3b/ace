...
1. **Artifacts exist** — At least one integration artifact exists in `results/6/` proving a downstream tool consumed the structured output (e.g., a directory was created from path output, a jq-extracted field is saved to a file).
