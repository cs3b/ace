...
Save all output to `results/5/`. Use descriptive filenames that identify the mode and stream
(e.g., `results/5/quiet.stdout`, `results/5/quiet.stderr`, `results/5/quiet.exit`).
