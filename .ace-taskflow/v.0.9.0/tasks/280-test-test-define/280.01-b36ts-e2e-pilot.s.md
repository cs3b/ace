...
- **Verifier**: File `goal/3/i50jj3` exists, content is a valid, plausible date/timestamp.
...
- [x] 8 runner.md files with Goal + Workspace + Constraints (no Steps, no hardcoded commands)
- [x] 8 verify.md files with Expectations + Verdict format (artifact-based, no access to runner reasoning)
