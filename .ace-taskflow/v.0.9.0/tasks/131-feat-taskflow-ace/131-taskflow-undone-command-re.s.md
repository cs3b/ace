...
- [ ] **Error Handling**: Gracefully handles cases where:
  - Task is not found in done directory
...
- Paths to `done` directory retrieved via ace-core's configuration cascade
...
- **Subdirectory Structure**: Handle tasks organized in subdirectories within done/
