...
- The output from the LLM, formatted by the template, should be saved as a new Markdown file in the `.ace/taskflow/backlog/ideas/` directory.
- A guide document (`.ace/handbook/guides/how-to-capture-ideas.guide.md`) should be created to explain the process and how to use the `bin/tci` tool.
