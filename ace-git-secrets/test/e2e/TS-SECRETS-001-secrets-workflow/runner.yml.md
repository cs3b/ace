---
description: "E2E runner input for ace-git-secrets goal-based tests"
bundle:
  ...
  files:
    ...
    - ./TC-002-secret-detection.runner.md
...
- Use only ace-git-secrets, git, jq, and standard shell utilities
