...
3. **Mentions subcommands** — `help.stdout` references at least two of: scan, rewrite-history, revoke.

## Verdict

- **PASS**: The help command succeeds and exposes the expected git-secrets command surface.
