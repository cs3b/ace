...
module Ace
  module Review
    ...
    module CLI
      ...
      # occurrences into comma-separated values before dry-cli parsing.
      #
      ...
      def self.preprocess_array_options(args)
        ...
        # Insert merged --subject and --model flags at the beginning of result
        # (after potential default command insertion)
        result.unshift("--model", accumulated_model.join(",")) unless accumulated_model.empty?
        result.unshift("--subject", accumulated_subject.join(",")) unless accumulated_subject.empty?
