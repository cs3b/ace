  ...
  module Review
    module Organisms
      ...
      class ReviewManager
        ...
        # @deprecated Use link_session_to_task_if_requested instead
        ...
        def save_multi_model_to_task(review_data, model_results)
          ...
          begin
            ...
            model_results.each do |model, model_result|
              ...
              result = Molecules::TaskReportSaver.save(task_info[:path], model_result[:output_file], model_review_data)
              task_paths << result[:path] if result[:success]
            end
        ...
        # @deprecated Use auto_link_session_if_enabled instead
