---
description: "E2E runner input for ace-review goal-based tests"
bundle:
  ...
  files:
    ...
    - ./TC-002-preset-discovery.runner.md
    - ./TC-003-preset-composition.runner.md
    - ./TC-004-subject-processing.runner.md
    - ./TC-005-error-handling.runner.md
    - ./TC-006-single-model.runner.md
    - ./TC-007-multi-model.runner.md
---

# E2E Test Runner: ace-review

Tool under test: ace-review
Required tools: ace-review, git
...
- Use only ace-review, git, and standard shell utilities
