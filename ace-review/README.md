...
```
.ace-local/review/sessions/review-20251202-104235/
├── system.prompt.md
├── user.prompt.md
├── metadata.yml
...
4. **Saves locally** to `.ace-local/review/sessions/pr-review-{timestamp}/`
...
```bash
# Review structure
.ace-local/review/sessions/pr-review-20251116-140530/
