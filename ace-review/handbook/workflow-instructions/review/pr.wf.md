...
**Examples:**
- `/ace_review_pr 123` → `ace-review --pr 123`
- `/ace_review_pr --preset code-deep` → `ace-review --pr <current-pr> --preset code-deep`
- `/ace_review_pr 123 --preset security` → `ace-review --pr 123 --preset security`
