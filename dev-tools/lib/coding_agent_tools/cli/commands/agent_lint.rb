    ...
    module Commands
      ...
      class AgentLint < Dry::CLI::Command
        ...
        def format_validation_result(result, options)
          ...
          output << ""
          output << if result[:claude_compatible] && result[:mcp_enhanced]
            "✓ This agent supports dual compatibility!"
            ...
            "⚠  This agent has MCP enhancements but may not work with Claude Code"
          else
            "✗ This agent needs updates for compatibility"
          end
