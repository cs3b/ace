...
RSpec.describe CodingAgentTools::Organisms::TogetheraiClient do
  ...
  describe "#generate_text" do
    ...
    context "with API errors" do
      it "handles 400 Bad Request" do
        ...
        end.to raise_error(CodingAgentTools::Error, /Together AI API Error \(400\): Bad request/)
      end
      ...
      it "handles 401 Unauthorized" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /Together AI API Error \(401\): Invalid API key/)
      end
      ...
      it "handles 429 Rate Limit" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /Together AI API Error \(429\): Rate limit exceeded/)
      end
      ...
      it "handles malformed response" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /Together AI API Error/)
      end
  ...
  describe "#count_tokens" do
    it "raises NotImplementedError" do
      ...
      end.to raise_error(NotImplementedError, "Token counting not directly supported by Together AI API")
    end
  end
  ...
  describe "#list_models" do
    ...
    context "with successful response" do
      let(:mock_response) do
        [
          {id: "deepseek-ai/DeepSeek-V3", object: "model", created: 1_687_882_411},
          {id: "meta-llama/Llama-2-70b-chat-hf", object: "model", created: 1_677_610_602},
          {id: "some-other-model", object: "model", created: 1_677_610_603},
          {id: "gpt-3.5-turbo-instruct", object: "model", created: 1_677_610_604}
        ]
      end
    ...
    context "with API error" do
      it "raises error" do
        ...
        expect do
          client.list_models
        end.to raise_error(CodingAgentTools::Error, /Together AI API Error \(401\): Unauthorized/)
      end
    end
  end
  ...
  describe "#model_info" do
    context "with successful response" do
      let(:models_response) do
        [
          {id: "deepseek-ai/DeepSeek-V3", object: "model", created: 1_687_882_411, owned_by: "together"},
          {id: "meta-llama/Llama-2-70b-chat-hf", object: "model", created: 1_677_610_602},
          {id: "gpt-3.5-turbo-instruct", object: "model", created: 1_677_610_604}
        ]
      end
    ...
    context "when model is found in filtered list" do
      ...
      let(:models_response) do
        [
          {id: "deepseek-ai/DeepSeek-V3", object: "model", created: 1_687_882_411},
          {id: "meta-llama/Llama-2-70b-chat-hf", object: "model", created: 1_677_610_602, owned_by: "meta"},
          {id: "gpt-3.5-turbo-instruct", object: "model", created: 1_677_610_604}
        ]
      end
      ...
      it "returns model info from filtered list" do
        ...
        expect(result[:created]).to eq(1_677_610_602)
    ...
    context "with API error" do
      it "raises error" do
        ...
        expect do
          client.model_info
        end.to raise_error(CodingAgentTools::Error, /Together AI API Error \(404\): Models endpoint not found/)
      end
    end
  end
  ...
  describe "error handling" do
    ...
    it "provides detailed error messages for nested error structures" do
      ...
      expect do
        client.generate_text("test prompt")
      end.to raise_error(CodingAgentTools::Error, /Together AI API Error \(400\): The model 'invalid-model' does not exist/)
    end
  end
