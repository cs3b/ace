...
RSpec.describe CodingAgentTools::Organisms::AnthropicClient do
  ...
  describe "#generate_text" do
    ...
    context "with API errors" do
      it "handles 400 Bad Request" do
        ...
        end.to raise_error(CodingAgentTools::Error, /Anthropic API Error \(400\): Bad request/)
      end
      ...
      it "handles 401 Unauthorized" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /Anthropic API Error \(401\): Invalid API key/)
      end
      ...
      it "handles 429 Rate Limit" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /Anthropic API Error \(429\): Rate limit exceeded/)
      end
      ...
      it "handles malformed response" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /Anthropic API Error/)
      end
      ...
      it "handles response where 'content' field is missing" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /'content' field is not an array/)
      end
      ...
      it "handles response where 'content' array is empty" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /'content' array is empty/)
      end
      ...
      it "handles response where text content is nil" do
        ...
        expect do
          client.generate_text(prompt)
        end.to raise_error(CodingAgentTools::Error, /No text blocks found in content/)
      end
    end
  end
  ...
  describe "#count_tokens" do
    it "raises NotImplementedError" do
      ...
      end.to raise_error(NotImplementedError, "Token counting not directly supported by Anthropic API")
    end
  end
  ...
  describe "error handling" do
    ...
    it "provides detailed error messages for nested error structures" do
      ...
      expect do
        client.generate_text("test prompt")
      end.to raise_error(CodingAgentTools::Error, /Anthropic API Error \(400\): The model 'invalid-model' does not exist/)
    end
  end
