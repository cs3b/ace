...
- `results/tc/03/stubbed-tools.stdout` includes `Available: 5/5 CLI tools installed`
- `results/tc/03/stubbed-tools.stdout` includes `Authenticated: 4/5 tools authenticated`
- `results/tc/03/stubbed-tools.stdout` includes `Ready: 5/5 tools ready for use`
