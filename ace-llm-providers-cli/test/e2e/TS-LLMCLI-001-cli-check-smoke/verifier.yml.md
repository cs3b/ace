---
description: "E2E verifier input for ace-llm-providers-cli-check smoke"
bundle:
  ...
  files:
    ...
    - ./TC-002-no-tools.verify.md
    - ./TC-003-stubbed-tools.verify.md
---

# E2E Verification: ace-llm-providers-cli-check smoke
