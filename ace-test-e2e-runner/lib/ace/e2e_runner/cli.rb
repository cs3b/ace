...
require "set"
require "ace/core"
require_relative "cli/commands/run_test"
require_relative "cli/commands/run_suite"
...
module Ace
  module E2eRunner
    ...
    module CLI
      ...
      register "run", CLI::Commands::RunTest
      register "suite", CLI::Commands::RunSuite

      # Version command
      version_cmd = Ace::Core::CLI::DryCli::VersionCommand.build(
        gem_name: "ace-test-e2e-runner",
