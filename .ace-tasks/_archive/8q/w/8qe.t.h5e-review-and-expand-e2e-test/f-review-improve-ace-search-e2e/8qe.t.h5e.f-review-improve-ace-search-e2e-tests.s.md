...
status: done
priority: medium
created_at: "2026-03-15 11:26:23"
estimate: TBD
dependencies: []
...
bundle:
  presets: [project]
  files: [ace-search/test-e2e/scenarios]
needs_review: false
---

# Review & improve ace-search E2E tests

## Behavioral Specification

### User Experience
- **Input**: Existing E2E test suite for `ace-search` (1 scenario, 3 test cases).
...
1. Run `/as-e2e-manage` on `ace-search` to run `review -> plan-changes -> rewrite`, producing a coverage matrix plus classified KEEP/MODIFY/REMOVE/CONSOLIDATE/ADD decisions.
...
4. Record package-scoped verification for `ace-test ace-search`.

### Success Criteria

- [x] Coverage matrix produced for `ace-search`
...
- **Slice Outcome**: `ace-search` E2E tests managed through review, plan, rewrite, and package-scoped verification
- **Advisory Size**: small
- **Context Dependencies**: Existing E2E test files in `ace-search/test-e2e/scenarios/`

### Verification Plan

#### Integration / E2E Validation
- [x] Package-scoped verification passes after rewrite: `ace-test ace-search`
- [x] Coverage matrix and change plan are attached or summarized in the task output

#### Verification Commands
- [x] `ace-test ace-search`

## Objective

Run the canonical E2E lifecycle for `ace-search`, ensuring review findings, rewrite decisions, and package-scoped verification are all captured consistently.

## Scope of Work

- Run the canonical lifecycle against existing 1 scenario and 3 test cases
