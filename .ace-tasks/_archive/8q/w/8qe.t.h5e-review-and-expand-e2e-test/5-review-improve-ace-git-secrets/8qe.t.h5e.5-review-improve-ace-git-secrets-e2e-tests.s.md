...
status: done
priority: medium
created_at: "2026-03-15 11:26:12"
estimate: TBD
dependencies: []
...
bundle:
  presets: [project]
  files: [ace-git-secrets/test-e2e/scenarios]
needs_review: false
---

# Review & improve ace-git-secrets E2E tests

## Behavioral Specification

### User Experience
- **Input**: Existing E2E test suite for `ace-git-secrets` (1 scenario, 7 test cases).
...
1. Run `/as-e2e-manage` on `ace-git-secrets` to run `review -> plan-changes -> rewrite`, producing a coverage matrix plus classified KEEP/MODIFY/REMOVE/CONSOLIDATE/ADD decisions.
...
4. Record package-scoped verification for `ace-test ace-git-secrets`.

### Success Criteria

- [ ] Coverage matrix produced for `ace-git-secrets`
...
- **Slice Outcome**: `ace-git-secrets` E2E tests managed through review, plan, rewrite, and package-scoped verification
- **Advisory Size**: small
- **Context Dependencies**: Existing E2E test files in `ace-git-secrets/test-e2e/scenarios/`

### Verification Plan

#### Integration / E2E Validation
- [ ] Package-scoped verification passes after rewrite: `ace-test ace-git-secrets`
- [ ] Coverage matrix and change plan are attached or summarized in the task output

#### Verification Commands
- [ ] `ace-test ace-git-secrets`

## Objective

Run the canonical E2E lifecycle for `ace-git-secrets`, ensuring review findings, rewrite decisions, and package-scoped verification are all captured consistently.

## Scope of Work

- Run the canonical lifecycle against existing 1 scenario and 7 test cases
