...
bundle:
  presets: [project]
  files: [ace-overseer/test-e2e/scenarios]
needs_review: false
---

# Review & improve ace-overseer E2E tests
...
- [x] Coverage matrix produced for `ace-overseer`
...
- **Advisory Size**: small
- **Context Dependencies**: Existing E2E test files in `ace-overseer/test-e2e/scenarios/`

### Verification Plan

#### Integration / E2E Validation
- [x] Package-scoped verification passes after rewrite: `ace-test ace-overseer`
- [x] Coverage matrix and change plan are attached or summarized in the task output

#### Verification Commands
- [x] `ace-test ace-overseer`
