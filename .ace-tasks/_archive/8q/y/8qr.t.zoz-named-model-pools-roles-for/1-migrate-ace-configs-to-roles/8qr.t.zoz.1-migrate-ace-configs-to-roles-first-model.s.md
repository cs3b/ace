...
| Shipped fixtures | review, sim, and git-commit fixture configs under the listed `test-e2e/scenarios/**/fixtures` paths | same roles used by shipped config surfaces |
...
- `ace-search "codex:|claude:|gemini:|google:|glite|openai:|zai:" --content --hidden --include "docs/**/*.md,ace-*/docs/**/*.md,ace-*/test-e2e/scenarios/**/fixtures/**/*.yml,.ace-tasks/8qr.t.zoz-named-model-pools-roles-for/1-migrate-ace-configs-to-roles/*.md" --max-results 200`
...
- Fixture configs in scope: `ace-git-commit/test-e2e/scenarios/TS-COMMIT-001-commit-workflow/fixtures/pkg-a/.ace/git/commit.yml`, `ace-git-commit/test-e2e/scenarios/TS-COMMIT-001-commit-workflow/fixtures/pkg-b/.ace/git/commit.yml`, `ace-review/test-e2e/scenarios/TS-REVIEW-001-review-workflow/fixtures/.ace/review/config.yml`, `ace-review/test-e2e/scenarios/TS-REVIEW-001-review-workflow/fixtures/.ace/review/presets/{single,multi,reviewers-test,level_1}.yml`, `ace-sim/test-e2e/scenarios/TS-SIM-001-next-phase-smoke/fixtures/.ace/sim/presets/{validate-task,validate-idea}.yml`
