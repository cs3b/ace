---
id: 8c0.t.077.a
title: "Reference Migration: Migrate `ace-b36ts/test-e2e/scenarios/` to Goal-Mode TC Structure"
status: done
priority: medium
...
# Reference Migration: Migrate `ace-b36ts/test-e2e/scenarios/` to Goal-Mode TC Structure
...
- [ ] `ace-b36ts/test-e2e/scenarios/` contains migrated scenario directory `TS-B36TS-001-pilot`
...
**In scope:** Live migration of `ace-b36ts/test-e2e/scenarios/` to the goal-mode TC structure:
...
Live package files under `ace-b36ts/test-e2e/scenarios/`:

```
ace-b36ts/test-e2e/scenarios/
└── TS-B36TS-001-pilot/
    ├── scenario.yml
    ├── runner.yml.md
    ├── verifier.yml.md
