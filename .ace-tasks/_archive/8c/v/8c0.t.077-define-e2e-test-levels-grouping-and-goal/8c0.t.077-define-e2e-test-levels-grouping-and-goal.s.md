...
- **280.01** — Reference Migration: Migrate live `ace-b36ts/test-e2e/scenarios/` to goal-mode TC structure (`TS-B36TS-001-pilot`)
...
- Live `ace-b36ts/test-e2e/scenarios/` migrated to `TS-B36TS-001-pilot` goal-mode TC structure
