...
1. Run `/as-e2e-review` on `ace-sim` to produce a coverage matrix mapping CLI functionality to existing E2E test coverage.
...
4. Verify all E2E tests pass with `ace-test ace-sim`.
...
- **Slice Outcome**: `ace-sim` E2E tests reviewed, improved, and verified
- **Advisory Size**: small
...
- [ ] All E2E tests pass: `ace-test ace-sim`
...
Review and improve the E2E test suite for `ace-sim`, ensuring comprehensive coverage with consistent patterns.

## Scope of Work

- Review existing 1 scenario and 4 test cases
