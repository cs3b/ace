...
1. Run `/as-e2e-review` on `ace-review` to produce a coverage matrix mapping CLI functionality to existing E2E test coverage.
...
4. Verify all E2E tests pass with `ace-test ace-review`.
...
- **Slice Outcome**: `ace-review` E2E tests reviewed, improved, and verified
- **Advisory Size**: small
...
- [ ] All E2E tests pass: `ace-test ace-review`
...
Review and improve the E2E test suite for `ace-review`, ensuring comprehensive coverage with consistent patterns.
