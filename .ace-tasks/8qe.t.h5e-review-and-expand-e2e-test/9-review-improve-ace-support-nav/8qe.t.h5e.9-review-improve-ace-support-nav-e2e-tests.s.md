...
# Review & improve ace-support-nav E2E tests

## Behavioral Specification

### User Experience
- **Input**: Existing E2E test suite for `ace-support-nav` (1 scenario, 5 test cases).
...
1. Run `/as-e2e-review` on `ace-support-nav` to produce a coverage matrix mapping CLI functionality to existing E2E test coverage.
...
4. Verify all E2E tests pass with `ace-test ace-support-nav`.
...
Review and improve the E2E test suite for `ace-support-nav`, ensuring comprehensive coverage with consistent patterns.
