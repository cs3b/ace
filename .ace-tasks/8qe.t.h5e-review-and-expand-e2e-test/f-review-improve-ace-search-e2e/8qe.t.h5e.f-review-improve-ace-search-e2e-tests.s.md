...
1. Run `/as-e2e-review` on `ace-search` to produce a coverage matrix mapping CLI functionality to existing E2E test coverage.
...
4. Verify all E2E tests pass with `ace-test ace-search`.
...
- **Slice Outcome**: `ace-search` E2E tests reviewed, improved, and verified
- **Advisory Size**: small
...
- [ ] All E2E tests pass: `ace-test ace-search`
...
Review and improve the E2E test suite for `ace-search`, ensuring comprehensive coverage with consistent patterns.
