...
1. Run `/as-e2e-review` on `ace-b36ts` to produce a coverage matrix mapping CLI functionality to existing E2E test coverage.
...
4. Verify all E2E tests pass with `ace-test ace-b36ts`.
...
- **Slice Outcome**: `ace-b36ts` E2E tests reviewed, improved, and verified
- **Advisory Size**: small
...
- [ ] All E2E tests pass: `ace-test ace-b36ts`
...
Review and improve the E2E test suite for `ace-b36ts`, ensuring comprehensive coverage with consistent patterns.

## Scope of Work

- Review existing 1 scenario and 8 test cases
