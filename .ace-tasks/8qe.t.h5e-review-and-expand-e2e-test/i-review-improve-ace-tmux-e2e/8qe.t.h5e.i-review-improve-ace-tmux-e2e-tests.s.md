...
1. Run `/as-e2e-review` on `ace-tmux` to produce a coverage matrix mapping CLI functionality to existing E2E test coverage.
...
4. Verify all E2E tests pass with `ace-test ace-tmux`.
...
- **Slice Outcome**: `ace-tmux` E2E tests reviewed, improved, and verified
- **Advisory Size**: small
...
- [ ] All E2E tests pass: `ace-test ace-tmux`
...
Review and improve the E2E test suite for `ace-tmux`, ensuring comprehensive coverage with consistent patterns.

## Scope of Work

- Review existing 1 scenario and 2 test cases
