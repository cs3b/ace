...
bundle:
  presets: [project]
  files: [ace-handbook-integration-pi/README.md]
  commands: []
---

# ace-handbook-integration-pi Light Refresh

## Objective

Light refresh of ace-handbook-integration-pi's README to apply consistent structure. Add clear tagline, consistent sections, keep existing docs. No GIF or getting-started.md needed -- this is a provider projection package. The current README (5 lines) has a title and one-line description. It needs a tagline, purpose, install, what it provides, and links to ace-handbook and ACE.

## Behavioral Specification

### User Experience
- **Input**: Current ace-handbook-integration-pi/README.md (5 lines)
...
4. What it provides (Pi provider manifests)
5. Link to ace-handbook and parent ACE project

Suggested tagline: "Pi-specific provider integration for ACE handbook skills."
...
- **Slice Type**: Subtask
- **Slice Outcome**: ace-handbook-integration-pi README refreshed with consistent structure
- **Advisory Size**: small
