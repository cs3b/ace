---
name: release-local
description: Prepare coordinated multi-package releases locally (version/changelog/lockfile/commit)
allowed-tools: Bash, Read, Edit
argument-hint: package-name... bump-level
doc-type: workflow
purpose: coordinated local release-preparation workflow
update:
...
This workflow is for local release preparation only and does **not** publish to RubyGems.
