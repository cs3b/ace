---
description: "E2E runner input for ace-compressor CLI smoke"
bundle:
  ...
  files:
    ...
    - ./TC-002-exact-stdio-and-stats.runner.md
    - ./TC-003-per-source-output.runner.md
    - ./TC-004-compact-refusal.runner.md
    - ./TC-005-agent-mode-smoke.runner.md
    - ./TC-006-benchmark-smoke.runner.md
---

# E2E Test Runner: ace-compressor CLI Smoke

Tool under test: ace-compressor
Required tools: ace-compressor, git
