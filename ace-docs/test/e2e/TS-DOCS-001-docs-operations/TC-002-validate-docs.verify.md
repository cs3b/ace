...
4. If fallback setup artifacts are present, they should be consistent with a seeded docs corpus; their absence alone is not a failure when validation output already proves the corpus existed.
