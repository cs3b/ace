---
description: "E2E runner input for ace-docs analyze and analyze-consistency workflows"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-005-analyze-doc-drift.runner.md
    - ./TC-006-analyze-consistency-report.runner.md
---

# E2E Test Runner: ace-docs Analysis Workflows
...
- Execute each goal in order (5 through 6)
