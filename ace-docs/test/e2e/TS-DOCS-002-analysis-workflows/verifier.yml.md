---
description: "E2E verifier input for ace-docs analyze and analyze-consistency workflows"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-005-analyze-doc-drift.verify.md
    - ./TC-006-analyze-consistency-report.verify.md
---

# E2E Verification: ace-docs Analysis Workflows
