---
description: "E2E runner input for ace-handbook CLI smoke"
bundle:
  ...
  files:
    ...
    - ./TC-002-status-table.runner.md
    - ./TC-003-status-json.runner.md
---

# E2E Test Runner: ace-handbook CLI Smoke
