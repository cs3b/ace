---
description: "E2E runner input for ace-handbook sync behavior"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-001-sync-provider-projection.runner.md
    - ./TC-002-status-unknown-provider-error.runner.md
    - ./TC-003-default-agents-projection.runner.md
---

# E2E Test Runner: ace-handbook sync behavior

Tool under test: ace-handbook
Required tools: ace-handbook
