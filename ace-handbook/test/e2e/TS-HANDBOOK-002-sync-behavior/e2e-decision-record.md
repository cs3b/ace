...
| TC-003 default-agents-projection | KEEP | Confirms plain sync writes common workflow skills into the neutral `.agents/skills` tree and status no longer treats legacy-targeted workflow projections as extras. | `test/fast/organisms/provider_syncer_test.rb`, `test/fast/organisms/status_collector_test.rb` |
