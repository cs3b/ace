...
bundle:
  ...
  files:
    ...
    - ./TC-003-default-agents-projection.verify.md
---
...
- Use impact-first verification order:
  ...
  1. final user-visible product output and sandbox/project state impact
  2. explicit contract artifacts under `results/tc/{NN}/`
