...
class PromptInitializerTest < Minitest::Test
  ...
  def test_setup_creates_prompt_from_template
    ...
    Ace::Prompt::Molecules::TemplateResolver.stub(:call, ->(**_) { { success: true, path: @template_file } }) do
      result = Ace::Prompt::Organisms::PromptInitializer.setup(
        target_dir: @tmpdir,
        force: false
      )
  ...
  def test_setup_handles_template_resolution_failure
    Ace::Prompt::Molecules::TemplateResolver.stub(:call, ->(**_) { { success: false, error: "Template not found" } }) do
      result = Ace::Prompt::Organisms::PromptInitializer.setup(
        target_dir: @tmpdir,
        force: false
      )
  ...
  def test_setup_uses_custom_template_uri
    ...
    Ace::Prompt::Molecules::TemplateResolver.stub(:call, stub_resolver) do
      result = Ace::Prompt::Organisms::PromptInitializer.setup(
  ...
  def test_reset_archives_and_restores
    ...
    Ace::Prompt::Molecules::TemplateResolver.stub(:call, ->(**_) { { success: true, path: @template_file } }) do
      result = Ace::Prompt::Organisms::PromptInitializer.reset(
        target_dir: @tmpdir,
        force: false
      )
  ...
  def test_default_constants
    ...
    assert_equal "the-prompt.md",
                 Ace::Prompt::Organisms::PromptInitializer::DEFAULT_PROMPT_FILE
  end

  def test_default_prompt_dir_uses_project_root
    # Should use ProjectRootFinder, not Dir.home
    default_dir = Ace::Prompt::Organisms::PromptInitializer.default_prompt_dir
    refute_nil default_dir
    assert default_dir.end_with?(".cache/ace-prompt/prompts")
  end
end
