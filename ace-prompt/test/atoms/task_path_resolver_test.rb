...
class TaskPathResolverTest < Minitest::Test
  ...
  def test_resolve_with_valid_task_id_returns_task_directory
    ...
    Ace::Taskflow::Organisms::TaskManager.stub :new, @mock_manager do
      result = Ace::Prompt::Atoms::TaskPathResolver.resolve("117")
  ...
  def test_resolve_with_subtask_id_returns_subtask_directory
    task_data = {
      path: "/project/.ace-taskflow/v.0.9.0/tasks/121-ace-prompt/121.01-archive.s.md",
    ...
    Ace::Taskflow::Organisms::TaskManager.stub :new, @mock_manager do
      result = Ace::Prompt::Atoms::TaskPathResolver.resolve("121.01")

      assert result[:found]
      assert_equal "/project/.ace-taskflow/v.0.9.0/tasks/121-ace-prompt", result[:path]
      assert_equal "/project/.ace-taskflow/v.0.9.0/tasks/121-ace-prompt/prompts", result[:prompts_path]
      assert_nil result[:error]
    end
  end
  ...
  def test_resolve_with_qualified_id_returns_task_directory
    ...
    Ace::Taskflow::Organisms::TaskManager.stub :new, @mock_manager do
      result = Ace::Prompt::Atoms::TaskPathResolver.resolve("v.0.9.0+task.117")
  ...
  def test_resolve_with_non_existent_task_returns_error
    ...
    Ace::Taskflow::Organisms::TaskManager.stub :new, @mock_manager do
      result = Ace::Prompt::Atoms::TaskPathResolver.resolve("999")
  ...
  def test_extract_from_branch_with_simple_task_id
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("117-feature-name")
    assert_equal "117", result
  end

  def test_extract_from_branch_with_subtask_id
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("121.01-archive")
    assert_equal "121.01", result
  end

  def test_extract_from_branch_with_main_returns_nil
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("main")
    assert_nil result
  end

  def test_extract_from_branch_with_number_not_at_start_returns_nil
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("feature-123")
    assert_nil result
  end

  def test_extract_from_branch_with_nil_returns_nil
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch(nil)
    assert_nil result
  end

  def test_extract_from_branch_with_empty_string_returns_nil
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("")
    assert_nil result
  end
  ...
  def test_extract_from_branch_with_subtask_in_branch_prefix
    ...
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("121.06-12106-task-id-folder-support")
    assert_equal "121.06", result
  end

  def test_extract_from_branch_with_double_digit_subtask
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("121.10-fix-enhancement-flow")
    assert_equal "121.10", result
  end

  def test_extract_from_branch_with_just_number_prefix
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("42-answer-everything")
    assert_equal "42", result
  end

  def test_extract_from_branch_with_version_like_number
    # Ensure patterns like v.0.9.0 don't match (start with letter)
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("v.0.9.0-release")
    assert_nil result
  end
  ...
  def test_extract_from_branch_with_custom_pattern
    ...
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("feat/123-add-feature", patterns: patterns)
  ...
  def test_extract_from_branch_with_multiple_patterns
    ...
    result1 = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("fix/456-bugfix", patterns: patterns)
    assert_equal "456", result1

    # Should fall through to second pattern
    result2 = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("789-feature", patterns: patterns)
    assert_equal "789", result2
  end

  def test_extract_from_branch_with_no_matching_pattern
    patterns = ['^(?:feat|fix)/(\d+)-']
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("123-feature", patterns: patterns)
    assert_nil result
  end

  def test_extract_from_branch_with_empty_patterns_array
    # Empty patterns should return nil
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("123-feature", patterns: [])
    assert_nil result
  end
  ...
  def test_extract_from_branch_uses_config_when_patterns_nil
    ...
    result = Ace::Prompt::Atoms::TaskPathResolver.extract_from_branch("121-feature", patterns: nil)
