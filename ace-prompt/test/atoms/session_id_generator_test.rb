...
class SessionIdGeneratorTest < Minitest::Test
  ...
  def test_generates_base36_id
    result = Ace::Prompt::Atoms::SessionIdGenerator.call
  ...
  def test_generates_base36_id_for_specific_time
    ...
    result = Ace::Prompt::Atoms::SessionIdGenerator.call(time: time)
  ...
  def test_generates_consistent_id_for_same_time
    time = Time.utc(2025, 11, 27, 14, 30, 0)
    result1 = Ace::Prompt::Atoms::SessionIdGenerator.call(time: time)
    result2 = Ace::Prompt::Atoms::SessionIdGenerator.call(time: time)
  ...
  def test_default_time_evaluates_at_call_time_not_load_time
    ...
    Time.stub(:now, t1) { result1 = Ace::Prompt::Atoms::SessionIdGenerator.call }
    Time.stub(:now, t2) { result2 = Ace::Prompt::Atoms::SessionIdGenerator.call }
  ...
  def test_valid_returns_true_for_base36
    assert Ace::Prompt::Atoms::SessionIdGenerator.valid?("i50jj3")
  end

  def test_valid_returns_false_for_invalid
    refute Ace::Prompt::Atoms::SessionIdGenerator.valid?("invalid")
  end

  def test_valid_returns_false_for_non_string
    refute Ace::Prompt::Atoms::SessionIdGenerator.valid?(123)
  end

  def test_valid_returns_false_for_nil
    refute Ace::Prompt::Atoms::SessionIdGenerator.valid?(nil)
  end

  def test_valid_returns_false_for_empty_string
    refute Ace::Prompt::Atoms::SessionIdGenerator.valid?("")
  end

  def test_valid_returns_false_for_invalid_base36_characters
    # 6 characters but contains invalid Base36 character (!)
    refute Ace::Prompt::Atoms::SessionIdGenerator.valid?("i50jj!")
  end
