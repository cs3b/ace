...
class ContentHasherTest < Minitest::Test
  def test_generates_hash_for_content
    result = Ace::Prompt::Atoms::ContentHasher.call(content: "test content")
  ...
  def test_returns_empty_hash_for_nil_content
    result = Ace::Prompt::Atoms::ContentHasher.call(content: nil)

    assert_equal "", result[:hash]
  end

  def test_returns_empty_hash_for_empty_content
    result = Ace::Prompt::Atoms::ContentHasher.call(content: "")
  ...
  def test_generates_consistent_hash
    ...
    result1 = Ace::Prompt::Atoms::ContentHasher.call(content: content)
    result2 = Ace::Prompt::Atoms::ContentHasher.call(content: content)
  ...
  def test_handles_unicode_content
    ...
    result = Ace::Prompt::Atoms::ContentHasher.call(content: content)
