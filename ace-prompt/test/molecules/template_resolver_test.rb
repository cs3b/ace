...
class TemplateResolverTest < Minitest::Test
  ...
  def test_normalizes_short_form_to_full_uri
    ...
    resolver = Ace::Prompt::Molecules::TemplateResolver
  ...
  def test_resolves_bundled_template
    ...
    result = Ace::Prompt::Molecules::TemplateResolver.call(uri: "tmpl://the-prompt-base")
  ...
  def test_handles_nonexistent_template
    result = Ace::Prompt::Molecules::TemplateResolver.call(uri: "tmpl://nonexistent-template")
  ...
  def test_handles_malformed_uri
    result = Ace::Prompt::Molecules::TemplateResolver.call(uri: "tmpl://")
  ...
  def test_handles_empty_protocol_response
    ...
    result = Ace::Prompt::Molecules::TemplateResolver.call(uri: "tmpl://invalid/empty")
  ...
  def test_returns_error_on_exception
    ...
    Ace::Prompt::Molecules::TemplateResolver.stub(:resolve_via_ace_nav, ->(_uri) { raise "Test error" }) do
      Ace::Prompt::Molecules::TemplateResolver.stub(:resolve_bundled_template, ->(_uri) { raise "Test error" }) do
        result = Ace::Prompt::Molecules::TemplateResolver.call(uri: "tmpl://test-template")
  ...
  def test_short_form_resolves_to_bundled_template
    ...
    result = Ace::Prompt::Molecules::TemplateResolver.call(uri: "base")
  ...
  def test_rejects_uri_with_spaces
    result = Ace::Prompt::Molecules::TemplateResolver.call(uri: "bug report")
  ...
  def test_accepts_path_like_short_form
    ...
    result = Ace::Prompt::Molecules::TemplateResolver.call(uri: "some-folder/test")
  ...
  def test_accepts_valid_short_forms
    ...
    valid_forms.each do |form|
      result = Ace::Prompt::Molecules::TemplateResolver.call(uri: form)
