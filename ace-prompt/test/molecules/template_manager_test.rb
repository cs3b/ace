...
class TemplateManagerTest < Minitest::Test
  ...
  def test_copy_template_creates_target_directory
    result = Ace::Prompt::Molecules::TemplateManager.copy_template(
  ...
  def test_archive_file_creates_archive_directory
    ...
    result = Ace::Prompt::Molecules::TemplateManager.archive_file(
  ...
  def test_restore_template_archives_existing_file
    ...
    result = Ace::Prompt::Molecules::TemplateManager.restore_template(
      template_path: @template_file,
      target_path: @target_file,
      archive_dir: @archive_dir,
      force: false
  ...
  def test_restore_template_handles_archive_failure
    ...
    Ace::Prompt::Molecules::TemplateManager.stub(:archive_file, ->(**_) { { success: false, error: "Archive failed" } }) do
      result = Ace::Prompt::Molecules::TemplateManager.restore_template(
        template_path: @template_file,
        target_path: @target_file,
        archive_dir: @archive_dir,
