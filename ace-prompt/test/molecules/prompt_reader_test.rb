...
class PromptReaderTest < Minitest::Test
  ...
  def test_reads_existing_file
    ...
    result = Ace::Prompt::Molecules::PromptReader.call(path: @test_file)
  ...
  def test_handles_missing_file
    ...
    result = Ace::Prompt::Molecules::PromptReader.call(path: missing_file)
  ...
  def test_handles_symlinked_file
    ...
    result = Ace::Prompt::Molecules::PromptReader.call(path: symlink_file)
