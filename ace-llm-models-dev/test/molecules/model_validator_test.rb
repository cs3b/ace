...
class ModelValidatorTest < ModelsDevTestCase
  def setup
    @temp_dir = Dir.mktmpdir("ace-llm-models-test")
    @cache_manager = Ace::LLM::ModelsDev::Molecules::CacheManager.new(cache_dir: @temp_dir)
    @validator = Ace::LLM::ModelsDev::Molecules::ModelValidator.new(cache_manager: @cache_manager)
  ...
  def test_max_levenshtein_length_constant_defined
    assert_equal 500, Ace::LLM::ModelsDev::Molecules::ModelValidator::MAX_LEVENSHTEIN_LENGTH
  end
