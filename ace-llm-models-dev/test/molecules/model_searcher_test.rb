...
class ModelSearcherTest < ModelsDevTestCase
  def setup
    @temp_dir = Dir.mktmpdir("ace-llm-models-test")
    @cache_manager = Ace::LLM::ModelsDev::Molecules::CacheManager.new(cache_dir: @temp_dir)
    @searcher = Ace::LLM::ModelsDev::Molecules::ModelSearcher.new(cache_manager: @cache_manager)
  ...
  def test_search_without_filters_only_instantiates_limited_models
    ...
    assert_kind_of Ace::LLM::ModelsDev::Models::ModelInfo, model
    assert model.id
  end
