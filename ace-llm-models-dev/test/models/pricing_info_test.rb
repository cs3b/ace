...
class PricingInfoTest < ModelsDevTestCase
  def test_from_hash_with_all_fields
    ...
    pricing = Ace::LLM::ModelsDev::Models::PricingInfo.from_hash(hash)
  ...
  def test_from_hash_with_nil
    pricing = Ace::LLM::ModelsDev::Models::PricingInfo.from_hash(nil)
  ...
  def test_available_returns_false_when_no_pricing
    pricing = Ace::LLM::ModelsDev::Models::PricingInfo.new
