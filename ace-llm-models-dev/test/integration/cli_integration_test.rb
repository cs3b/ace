...
# Integration tests for ace-llm-models CLI commands
# Tests end-to-end workflows including:
# - Provider sync with --apply flag
# - Provider sync with --commit flag (mocked)
# - Filter validation in search
class CLIIntegrationTest < ModelsDevTestCase
  def setup
    @tmpdir = Dir.mktmpdir("ace-llm-models-integration")
  ...
  def test_sync_commit_executes_git_commit_command
    ...
    orchestrator = Ace::LLM::ModelsDev::Organisms::ProviderSyncOrchestrator.new(
  ...
  def create_cache_manager
    Ace::LLM::ModelsDev::Molecules::CacheManager.new(cache_dir: @cache_dir)
  end
