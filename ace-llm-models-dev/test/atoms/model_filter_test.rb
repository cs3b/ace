...
class ModelFilterTest < ModelsDevTestCase
  def setup
    @filter = Ace::LLM::ModelsDev::Atoms::ModelFilter
  ...
  def create_test_models
    [
      ...
      Ace::LLM::ModelsDev::Models::ModelInfo.new(
        id: "gpt-4o",
        name: "GPT-4o",
        provider_id: "openai",
        pricing: Ace::LLM::ModelsDev::Models::PricingInfo.new(input: 2.5, output: 10.0),
      ...
      Ace::LLM::ModelsDev::Models::ModelInfo.new(
        ...
        name: "o1",
        provider_id: "openai",
        pricing: Ace::LLM::ModelsDev::Models::PricingInfo.new(input: 15.0, output: 60.0),
      ...
      Ace::LLM::ModelsDev::Models::ModelInfo.new(
        ...
        pricing: Ace::LLM::ModelsDev::Models::PricingInfo.new(input: 3.0, output: 15.0),
        context_limit: 200_000,
        modalities: { input: %w[text image], output: ["text"] },
      ...
      Ace::LLM::ModelsDev::Models::ModelInfo.new(
        ...
        name: "Llama 3",
        provider_id: "meta",
        pricing: Ace::LLM::ModelsDev::Models::PricingInfo.new(input: 0.5, output: 0.5),
        context_limit: 8192,
        modalities: { input: ["text"], output: ["text"] },
        capabilities: { reasoning: false, tool_call: true, attachment: false },
        open_weights: true
      ...
      Ace::LLM::ModelsDev::Models::ModelInfo.new(
        ...
        name: "Gemini 2",
        provider_id: "google",
        pricing: Ace::LLM::ModelsDev::Models::PricingInfo.new(input: 1.0, output: 2.0),
