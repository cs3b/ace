...
### Repository Types and Coordination

This project uses a multi-repository architecture with **4 Git repositories**:

- **Main repository**: Root project coordination
- **dev-handbook/**: Development guides and workflows (submodule)
- **dev-taskflow/**: Task management and documentation (submodule)
- **dev-tools/**: CLI tools and utilities (submodule)
