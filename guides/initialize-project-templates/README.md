...
3. Set up API keys or other required credentials
...
<!-- More complex examples or configuration options -->
...
<!-- If applicable, link to or describe API endpoints -->
...
|--------|-------------|---------|----------|
| CONFIG_VAR_1 | Description | default_value | Yes/No |
| CONFIG_VAR_2 | Description | default_value | Yes/No |
