  ...
  module Coworker
    module Atoms
      ...
      module StepSorter
        ...
        #
        # @example
        #   sort(["020-bar.md", "010-foo.md", "010.01-baz.md"])
        #   # => ["010-foo.md", "010.01-baz.md", "020-bar.md"]
        ...
        #
        # @example
        #   sort_key("010-foo.md")      # => [10, 0, 0]
        #   sort_key("010.01-bar.md")   # => [10, 1, 0]
        #   sort_key("010.01.05-baz.md") # => [10, 1, 5]
        def self.sort_key(filename)
          # Extract number from filename (strip .j.md or .r.md extension)
