...
module Ace
  module Coworker
    module Atoms
      # Pure functions for expanding preset templates into job steps.
      #
      ...
      module PresetExpander
        ...
        #   params = { "taskrefs" => ["148", "149"], "review_preset" => "batch" }
        #   steps = PresetExpander.expand(preset, params)
        ...
        #   parse_array_parameter("148,149,150") # => ["148", "149", "150"]
        #
        # @example Range
        #   parse_array_parameter("148-150") # => ["148", "149", "150"]
        #
        # @example Pattern (returned as-is for later resolution)
        #   parse_array_parameter("240.*") # => ["240.*"]
        #
        # @example Already an array
        #   parse_array_parameter(["148", "149"]) # => ["148", "149"]
