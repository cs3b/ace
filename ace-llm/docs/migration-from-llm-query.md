...
| Option | llm-query | ace-llm | Notes |
|--------|-----------|---------------|-------|
...
1. **Command Implementation**:
   ...
   - ace-llm: Plain Ruby class with OptionParser

2. **Client Registration**:
   - llm-query: Dynamic registration via ClientFactory
   - ace-llm: Explicit require and case statement

3. **Error Handling**:
   - llm-query: Complex security validators and middleware
   - ace-llm: Simplified inline validation

4. **Observability**:
   - llm-query: dry-monitor events and notifications
   - ace-llm: Simple debug output (no event system)

### 5. Feature Differences

| Feature | llm-query | ace-llm | Notes |
|---------|-----------|---------------|-------|
...
2. **Update PATH or create alias**:
   ```bash
   alias llm-query='ace-llm/exe/ace-llm'
   ```
