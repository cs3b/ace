---
description: "E2E verifier input for ace-tmux outside-tmux window targeting"
bundle:
  ...
  params:
    ...
    max_size: 81920
  files:
    - ./TC-005-window-outside-tmux.verify.md
---

# E2E Verification: ace-tmux Outside-Tmux Window Targeting
...
- Evaluate goals based only on artifacts in `results/`
...
### Goal 5 — Outside-Tmux Window Targeting
- **Verdict**: PASS | FAIL
