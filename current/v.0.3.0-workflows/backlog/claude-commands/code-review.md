...
- Scripts: `bin/cr` (prompt generator), `dev-tools/dev-tools/exe/llm-query` (LLM interface)
...
dev-tools/dev-tools/exe/llm-query gpro cr-prompt.md \
...
for provider in gpro csonet; do
  dev-tools/dev-tools/exe/llm-query $provider cr-prompt.md \
    --system dev-handbook/guides/code-review/_code-review-system.md \
    --timeout 300 \
...
dev-tools/dev-tools/exe/llm-query gpro cr-prompt.md --system dev-handbook/guides/code-review/_code-review-system.md --timeout 300 -o cr-report-gpro.md
```
...
bin/cr -d input.diff -o cr-prompt.md
dev-tools/dev-tools/exe/llm-query csonet cr-prompt.md --system dev-handbook/guides/code-review/_code-review-system.md --timeout 300 -o cr-report-csonet.md
```
