  ...
  describe "#validate_threshold" do
    ...
    context "with invalid thresholds" do
      it "raises error for nil" do
        ...
        }.to raise_error(described_class::ValidationError, "Threshold cannot be nil")
      end

      it "raises error for values below 0" do
        expect {
          subject.validate_threshold(-1)
        }.to raise_error(described_class::ValidationError, /must be between 0 and 100/)
      end
      ...
      it "raises error for non-numeric strings" do
        ...
        }.to raise_error(described_class::ValidationError, /Cannot convert/)
      end

      it "raises error for arrays" do
        expect {
          subject.validate_threshold([85])
        }.to raise_error(described_class::ValidationError, /must be numeric/)
      end
    end
  end
  ...
  describe "#validate_file_pattern" do
    ...
    context "with invalid patterns" do
      it "raises error for path traversal" do
        ...
        }.to raise_error(described_class::ValidationError, /path traversal/)
      end

      it "raises error for non-string input" do
        expect {
          subject.validate_file_pattern(123)
        }.to raise_error(described_class::ValidationError, /must be a string/)
      end
    end
  end
  ...
  describe "#validate_format" do
    ...
    context "with invalid formats" do
      it "raises error for unsupported format" do
        ...
        }.to raise_error(described_class::ValidationError, /must be one of/)
      end
