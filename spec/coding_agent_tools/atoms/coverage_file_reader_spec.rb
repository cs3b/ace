  ...
  describe "#read" do
    ...
    context "with non-existent file" do
      it "raises InvalidFileError" do
        ...
        }.to raise_error(described_class::InvalidFileError, /File does not exist/)
      end
    end
    ...
    context "with malformed JSON" do
      ...
      it "raises MalformedJsonError" do
        ...
        }.to raise_error(described_class::MalformedJsonError, /Invalid JSON/)
      end
    end
  end
  ...
  describe "#validate_structure" do
    ...
    context "with invalid root structure" do
      it "raises error for non-hash root" do
        ...
        }.to raise_error(described_class::InvalidFileError, /Root must be a hash/)
      end
    end
    ...
    context "with missing coverage key" do
      ...
      it "raises error for missing coverage" do
        ...
        }.to raise_error(described_class::InvalidFileError, /missing 'coverage' key/)
      end
    end
    ...
    context "with invalid lines structure" do
      ...
      it "raises error for non-array lines" do
        expect {
          subject.validate_structure(invalid_data)
        }.to raise_error(described_class::InvalidFileError, /lines must be an array/)
      end
    end
  end
