  ...
  describe '.read_file' do
    ...
    context 'when file does not exist' do
      it 'raises an error' do
        ...
        end.to raise_error(CodingAgentTools::Error, /YAML file not found/)
      end
    end
    ...
    context 'when file contains invalid YAML syntax' do
      it 'raises an error with syntax information' do
        Tempfile.create(['invalid', '.yml']) do |file|
          ...
          end.to raise_error(CodingAgentTools::Error, /Invalid YAML syntax/)
        end
      end
    end
    ...
    context 'when file is unreadable' do
      it 'raises an error' do
        ...
        end.to raise_error(CodingAgentTools::Error, /Failed to read YAML file/)
      end
    end
  end
  ...
  describe '.parse_content' do
    ...
    context 'when YAML parsing fails for other reasons' do
      it 'raises a general error' do
        ...
        end.to raise_error(CodingAgentTools::Error, /Failed to parse YAML content/)
      end
    end
  end
end
