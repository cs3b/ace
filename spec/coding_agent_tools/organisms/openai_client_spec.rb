...
RSpec.describe CodingAgentTools::Organisms::OpenaiClient do
  ...
  describe "#generate_text" do
    ...
    context "with API errors" do
      it "handles 400 Bad Request" do
        ...
        }.to raise_error(CodingAgentTools::Error, /OpenAI API Error \(400\): Bad request/)
      end
      ...
      it "handles 401 Unauthorized" do
        ...
        expect {
          client.generate_text(prompt)
        }.to raise_error(CodingAgentTools::Error, /OpenAI API Error \(401\): Invalid API key/)
      end
      ...
      it "handles 429 Rate Limit" do
        ...
        expect {
          client.generate_text(prompt)
        }.to raise_error(CodingAgentTools::Error, /OpenAI API Error \(429\): Rate limit exceeded/)
      end
      ...
      it "handles malformed response" do
        ...
        expect {
          client.generate_text(prompt)
        }.to raise_error(CodingAgentTools::Error, /OpenAI API Error/)
      end
  ...
  describe "#count_tokens" do
    it "raises NotImplementedError" do
      ...
      }.to raise_error(NotImplementedError, "Token counting not directly supported by OpenAI API")
    end
  end
  ...
  describe "#list_models" do
    ...
    context "with API error" do
      it "raises error" do
        ...
        expect {
          client.list_models
        }.to raise_error(CodingAgentTools::Error, /OpenAI API Error \(401\): Unauthorized/)
      end
    end
  end
  ...
  describe "#model_info" do
    ...
    context "with API error" do
      it "raises error" do
        ...
        expect {
          client.model_info
        }.to raise_error(CodingAgentTools::Error, /OpenAI API Error \(404\): Model not found/)
      end
    end
  end
  ...
  describe "error handling" do
    ...
    it "provides detailed error messages for nested error structures" do
      ...
      expect {
        client.generate_text("test prompt")
      }.to raise_error(CodingAgentTools::Error, /OpenAI API Error \(400\): The model 'invalid-model' does not exist/)
    end
  end
