  ...
  describe "#process" do
    context "with string input" do
      ...
      it "raises error for empty prompt" do
        expect {
          processor.process("")
        }.to raise_error(CodingAgentTools::Error, "Prompt cannot be empty")
      end
    ...
    context "with file input" do
      ...
      it "raises error for non-existent file" do
        ...
        }.to raise_error(CodingAgentTools::Error, "Prompt file not found: /non/existent/file.txt")
      end
      ...
      it "raises error for file exceeding size limit" do
        ...
        }.to raise_error(CodingAgentTools::Error, /File too large: \d+ bytes \(max: 1024\)/)
      end
  ...
  describe "#extract_from_json" do
    ...
    context "with invalid JSON" do
      it "raises error for invalid JSON syntax" do
        ...
        }.to raise_error(CodingAgentTools::Error, "Invalid JSON in file: #{json_file.path}")
      end
      ...
      it "raises error for missing key" do
        ...
        expect {
          processor.extract_from_json(json_file.path)
        }.to raise_error(CodingAgentTools::Error, "Key 'prompt' not found in JSON data")
      end
    end
  end
  ...
  describe "#format_template" do
    ...
    context "with missing variables" do
      it "raises error for unfilled variables" do
        ...
        }.to raise_error(CodingAgentTools::Error, "Unfilled template variables: age")
      end
      ...
      it "lists all unfilled variables" do
        ...
        expect {
          processor.format_template(template, variables)
        }.to raise_error(CodingAgentTools::Error, "Unfilled template variables: name, age, location")
      end
    end
  ...
  describe "#validate" do
    ...
    context "with length validation" do
      ...
      it "raises error for prompt exceeding length" do
        ...
        }.to raise_error(CodingAgentTools::Error, "Prompt exceeds maximum length of 10 characters")
      end
    end
  end
