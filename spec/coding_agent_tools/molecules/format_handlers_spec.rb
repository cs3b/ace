...
RSpec.describe CodingAgentTools::Molecules::FormatHandlers do
  ...
  describe '.get_handler' do
    ...
    it 'raises error for unsupported format' do
      ...
      end.to raise_error(CodingAgentTools::Error, 'Unsupported format: xml')
    end
  ...
  describe '.supported_formats' do
    it 'returns array of supported formats' do
      ...
      expect(formats).to eq(['json', 'markdown', 'text'])
    end
  end
  ...
  describe 'Base handler' do
    ...
    describe '#format' do
      it 'raises NotImplementedError' do
        ...
        end.to raise_error(NotImplementedError, 'Subclasses must implement #format')
      end
    end
    ...
    describe '#validate_response' do
      ...
      it 'raises error for response without text' do
        ...
        end.to raise_error(CodingAgentTools::Error, 'Invalid response format: missing :text field')
      end
