...
RSpec.describe CodingAgentTools::Molecules::TaskflowManagement::GitLogFormatter do
  ...
  describe "LogEntry struct" do
    ...
    describe "#formatted_timestamp" do
      it "formats timestamp with default format" do
        expected = Time.at(1672531200).strftime("%Y-%m-%d %H:%M")
  ...
  describe "LogResult struct" do
    let(:entries) do
      [
        described_class::LogEntry.new("repo1", 1672531200, "abc", "John", "msg1", "1672531200"),
        described_class::LogEntry.new("repo2", 1672617600, "def", "Jane", "msg2", "1672617600")
      ]
    end
  ...
  describe ".get_multi_repo_log" do
    ...
    it "raises error for invalid time format" do
      expect {
        described_class.get_multi_repo_log(repositories, since_time: 12345)
      }.to raise_error(ArgumentError, "Invalid time format: Integer")
    end
  end
  ...
  describe ".format_log_output" do
    let(:entries) do
      [
        described_class::LogEntry.new("repo1", 1672531200, "abc123", "John Doe", "Initial commit\n\nAdded functionality", "1672531200"),
        described_class::LogEntry.new("repo2", 1672617600, "def456", "Jane Smith", "Fix bug", "1672617600")
      ]
    end
