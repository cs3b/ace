---
description: "E2E runner input for ace-prompt-prep goal-based tests"
bundle:
  ...
  files:
    ...
    - ./TC-003-setup-workspace.runner.md
    - ./TC-004-task-scoped-process.runner.md
---

# E2E Test Runner: ace-prompt-prep

Tool under test: ace-prompt-prep
